  ...
  const structuredData = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "url": "https://cursortutorial.ai",
        "name": "Cursor Tutorial",
        "description": "Master Cursor 1.7.39 with comprehensive tutorials on Tab completion, Cmd+K, AI Chat, Composer, @ symbols, and more",
        "publisher": {
          "@id": "https://cursortutorial.ai/#organization"
        },
        "potentialAction": {
      ...
      },
      {
        ...
        "description": "Master Cursor 1.7.39 with Tab completion, Cmd+K inline editing, AI Chat, Composer, @ symbols, and Cursor Rules. Learn Claude 4.5 Sonnet integration in 10 minutes.",
        "provider": {
          "@id": "https://cursortutorial.ai/#organization"
        },
      ...
      },
      {
        ...
        "description": "Learn Cursor 1.7.39 and become 10x faster in 10 minutes",
        "totalTime": "PT10M",
        "step": [
          {
            "@type": "HowToStep",
