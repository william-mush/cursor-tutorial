...
export const metadata: Metadata = {
  ...
  description: "Complete Cursor 1.7.52 tutorial with Tab completion, Cmd+K, AI Chat, Composer, and Claude Haiku. Learn AI-powered development in 10 minutes. Free guide with real examples.",
  keywords: [
    // Core Features
    "Cursor tutorial",
    "Cursor 1.7 guide",
  ...
  openGraph: {
    ...
    description: "Complete Cursor 1.7.52 tutorial with Tab completion, Cmd+K, AI Chat, Composer, and Claude Haiku. Learn in 10 minutes with real examples.",
  ...
  twitter: {
    ...
    description: "Complete Cursor 1.7.52 tutorial: Tab completion, Cmd+K, AI Chat, Composer. Real examples with Claude Haiku.",
    images: ['/og-image.png'],
