...
-- Step 4: Create new table with 512 dimensions
...
-- Step 8: Create index with 512 dimensions
CREATE INDEX cursor_content_embedding_idx 
ON cursor_content 
USING ivfflat (embedding vector_cosine_ops)
WITH (lists = 100);

-- Step 9: Create search function with 512 dimensions
...
-- Step 10: Create similar content function with 512 dimensions
